...
class BrowserAutomation:
    ...
    def get_dingdan(self):
        ...
        # 定单选择表格,要获取定单选择，上面就不能刷新表单，也就是要去掉点击那两步
        # tab_select_str = '#__grid_goods_grid > div:nth-child(1) > div.objbox > table'
        # tab_html = browser_automation.get_table_html(tab_select_str)
        # select_data = browser_automation.get_table_select(tab_html)
        # print(select_data, len(select_data), len(select_data[1]))
